    ...
    <div className="min-h-screen flex items-center justify-center bg-[#1a1a1a]">
      <div className="w-full max-w-sm px-6">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-2xl font-semibold text-[#e8e8e8]">Kronos</h1>
          <p className="text-sm text-[#999] mt-1">Your AI-powered calendar</p>
        </div>
        ...
        <button
          ...
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 px-4 py-3.5 rounded-lg bg-[#2a2a2a] border border-[#333] text-[#e8e8e8] hover:bg-[#333] transition-colors text-sm font-medium disabled:opacity-50"
        >
          {isLoading ? (
